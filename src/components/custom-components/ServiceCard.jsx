...
const ServiceCard = ({ name, img, img1, description }) => {
  return (
    <div className="bg-[#FCC215]/60 h-[350px] w-fit text-black rounded-xl shadow-lg flex flex-col p-4">
      ...
      <div className="flex flex-col justify-center items-center gap-2 p-1 text-center">
        ...
        <button className="bg-[#f2b02d] text-black text-xs h-[25px] px-6 py-0 rounded-xl mt-2">
          {name}
        </button>
      </div>
    </div>
