...
const ServiceSection = () => {
  ...
  const data = [
    {
      name: "DRIVING",
      img: "/assets/service_section/driver.png",
      description:
        "Our professional drivers prioritize your safety and punctuality. With expert navigation skills, they ensure a smooth and efficient journey. Trust us to get you to your destination comfortably and on time.",
    },
    {
      name: "CLEANING",
      img: "/assets/service_section/cleaning.png",
      description:
    ...
    {
      name: "COOKING",
      img: "/assets/service_section/cooking.png",
      description:
    ...
    {
      name: "PAINTING",
      img: "/assets/service_section/painting.png",
      description:
    ...
    {
      name: "REPAIRING",
      img: "/assets/service_section/reparing.png",
      description:
    ...
    {
      name: "PLUMBING",
      img: "/assets/service_section/plumbing.png",
      description:
    ...
    {
      name: "BEAUTY",
      img: "/assets/service_section/beauty.png",
      description:
    ...
    {
      name: "ELDER CARE",
      img: "/assets/service_section/elder.png",
      description:
    ...
    {
      name: "CHILD CARE",
      img: "/assets/service_section/child.png",
      description:
          ...
          {data.map((d, index) => (
            ...
            >
              ...
              <div className="flex flex-col justify-center items-center gap-2 p-2 text-center">
                ...
                <button className="bg-[#f2b02d] text-black text-[12.4px] h-[40px] px-6 py-1 rounded-xl mt-2">
                  {d.name}
                </button>
              </div>
            </div>
